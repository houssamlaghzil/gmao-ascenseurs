/**
 * Pagination de la liste des interventions — composant serveur : de simples
 * liens préservant les filtres actifs dans la query string. Même
 * convention que app/parc/components/PaginationAppareils.tsx.
 */
...
interface PaginationInterventionsProps {
  searchParams: SearchParamsRecord;
  pageActuelle: number;
  totalPages: number;
}

export default function PaginationInterventions({ searchParams, pageActuelle, totalPages }: PaginationInterventionsProps) {
