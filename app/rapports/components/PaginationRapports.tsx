/**
 * Pagination de la liste des rapports — composant serveur : de simples
...
interface PaginationRapportsProps {
  searchParams: SearchParamsRecord;
  pageActuelle: number;
  totalPages: number;
}

export default function PaginationRapports({ searchParams, pageActuelle, totalPages }: PaginationRapportsProps) {
